...
/usr/bin/arm-none-eabi-as -mfloat-abi=hard -meabi=5 -march=armv6 -mfpu=vfpv2 -o nimprogram.o  nimprogram.s
...
IFS="
"
/usr/bin/arm-none-eabi-objcopy -O binary nimprogram.elf kernel.img
if [ $? != 0 ]; then DoExitLink nimprogram; fi
IFS=$OFS
